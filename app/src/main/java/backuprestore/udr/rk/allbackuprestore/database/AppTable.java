...
public class AppTable {
    ...
    public static final String TableName = "AppsTable";
...
//    }
    ...
    public static String getSelectedData(String apppackage) {
        ...
        String Query = "SELECT isSelected FROM " + TableName + " where appPackage ='" + pack + "'";
        cursor = sqldb.rawQuery(Query, null);
        if (cursor != null && cursor.moveToFirst()) {
            isbackup = cursor.getString(cursor.getColumnIndex(ISSELECTED));
            cursor.close();
    ...
    public static String getBackupData(String apppackage) {
        ...
        String isbackup = "";
        String pack = "\"" + apppackage + "\"";
        String Query = "SELECT isBackup FROM " + TableName + " where appPackage ='" + pack + "'";
        cursor = sqldb.rawQuery(Query, null);
        if (cursor != null && cursor.moveToFirst()) {
    ...
    public static ArrayList<AppModel> getAppData() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            do {
                ...
                if (cursor.getString(cursor.getColumnIndex(ISSELECTED)).equals("0")) {
